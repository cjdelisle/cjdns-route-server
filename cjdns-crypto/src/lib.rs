...
pub mod sign_ext {
    ...
    pub fn sign_ed25519_pk_to_curve25519(public_key: sodiumoxide::crypto::sign::ed25519::PublicKey) -> Result<[u8; SIGN_KEY_SIZE], ()> {
        let mut res = [0_u8; SIGN_KEY_SIZE];
        let err_code = unsafe { crypto_sign_ed25519_pk_to_curve25519(res.as_mut_ptr(), public_key.0.as_ptr()) };
